...
const App = () => {
  ...
  const fetchData = async() => {
    ...
    setTodoArray(data.data.filter((task) => task.moveToTrash === false && task.complete === false))
  ...
  const renderByType = async(type) => {
    ...
    if(type === "All"){
      ...
      setTodoArray(data.data.filter((task) => task.moveToTrash !== true && task.complete === false))
      ...
      const filteredArray = currentTodoArray.filter((task) => task.type === type && task.moveToTrash === false && task.complete === false
      )
  ...
  return (
    <DataContext.Provider value={{todoArray,addNewTodoToServer,deleteTodo, HandleComplete, renderByType, activeTab,setActiveTab, moveToTrash }}>
