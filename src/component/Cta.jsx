...
const Cta = () => {
  ...
  return (
    <section className="py-0 max-w-7xl mx-auto lg:py-24 ">
      <div className="px-4 py-10 lg:rounded-[2rem] shadow-xl mx-auto  sm:px-6 lg:px-8 flex flex-col items-center justify-center lg:gap-10 gap-5 bg-[url('./assets/ctabg.png')] bg-cover">
        ...
        <button
          onClick={handleNav}
          className="inline-flex items-center justify-center px-6 py-4 text-base font-semibold text-white transition-all duration-200 bg-purple-600 border border-transparent rounded-md hover:bg-purple-700 focus:bg-purple-700"
          role="button"
        >
          Start for Free now
        </button>
