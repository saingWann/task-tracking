...
const Form = () => {
  ...
  const {addNewTodoToServer,edit,editCardItem,taskToEdit,showForm,setShowForm,setTaskToEdit,setEdit} = useContext(DataContext)
  ...
  return (
    ...
    className="z-10 w-full h-screen top-0 left-0 fixed flex justify-center items-center bg-black bg-opacity-50 ">
      <m.form
        ...
        <h2 className="text-gray-900 text-xl mb-1 font-medium">Update task info</h2>
