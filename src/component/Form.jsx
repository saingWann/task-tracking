...
const Form = ({setShowForm,showForm}) => {
  ...
  return (
    <div className='w-full h-screen top-0 left-0 fixed flex justify-center items-center bg-black bg-opacity-25 '>
      ...
      <span className='absolute top-10 right-10 hover:scale-105 cursor-pointer active:scale-100' onClick={() =>setShowForm(false)(false)}><CopyX /></span>
      ...
      <div className="relative mb-4">
        ...
        <input type="text" id="name" placeholder='Enter title...' name="name" className="w-full bg-white rounded border border-gray-300 mt-2 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
      </div>
      <div className="relative mb-4">
