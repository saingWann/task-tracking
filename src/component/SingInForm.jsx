...
import { addUser, setCurrentUser } from "../features/auth/authentication";
      ...
      <section className=" mx-auto w-[80%]">
        <div className="flex flex-col justify-center items-center py-10 min-h-screen">
          ...
          {localStorage.getItem("auth") ? (
            <div className="bg-gray-100 lg:p-10 p-5 flex flex-col gap-10 mt-10">
              <p>"Please log out first to crerat a new account."</p>
              <button
                className=" px-3 sm:px-5 py-2.5 text-sm sm:text-base font-semibold transition-all duration-200 text-white hover:bg-black/40 bg-black focus:bg-black/40 rounded-lg"
